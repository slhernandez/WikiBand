...
+ (NSArray *)artistItems {
    return @[
             [[Artist alloc] initWithArtist:@"Beck" image:[UIImage imageNamed:@"Beck"] bio:@"Beck Hansen (born Bek David Campbell, July 8, 1970[4]), known by the stage name Beck, is an American musician, singer-songwriter and multi-instrumentalist. Beck rose to fame in the early 1990s with his lo-fi, sonically experimental style, and he became well known for creating musical collages of a wide range of styles."],
             [[Artist alloc] initWithArtist:@"Carrie Underwood" image:[UIImage imageNamed:@"CarrieUnderwood"] bio:@"Carrie Marie Underwood (born March 10, 1983) is an American country music singer, songwriter, and actress. She rose to fame as the winner of the fourth season of American Idol in 2005. Underwood has since become one of the most prominent mainstream recording artists in the music industry, setting and breaking several records throughout her career."],
             [[Artist alloc] initWithArtist:@"Childish Gambino" image:[UIImage imageNamed:@"ChildishCambino"] bio:@"Donald McKinley Glover[1] /ˈɡlʌvər/ (born September 25, 1983), also known by his stage name Childish Gambino, is an American actor, writer, comedian, rapper, and producer. He first came to attention for his work with Derrick Comedy and subsequently became a writer for the NBC comedy series 30 Rock."],
             ...
             [[Artist alloc] initWithArtist:@"The National" image:[UIImage imageNamed:@"TheNational"] bio:@"The National is an American indie rock band formed in Cincinnati, Ohio, United States, in 1999, and currently based in Brooklyn. The band's lyrics, which have been described as dark, melancholy and difficult to interpret,[1] are written and sung by Matt Berninger, a baritone."],
