...
+ (NSArray *)artistItems {
    return @[
             ...
             [[Artist alloc] initWithArtist:@"Carrie Underwood" image:[UIImage imageNamed:@"CarrieUnderwood"] bio:@"Carrie Marie Underwood (born March 10, 1983) is an American country music singer, songwriter, and actress. She rose to fame as the winner of the fourth season of American Idol in 2005. Underwood has since become one of the most prominent mainstream recording artists in the music industry, setting and breaking several records throughout her career." image:[UIImage imageNamed:@"CarrieDetailsHero"]]
